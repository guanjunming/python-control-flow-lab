...
def weather_advice():
    ...
    is_cold = cold.lower() == 'y'
    is_raining = raining.lower() == 'y'
...
def guess_number():
    ...
    for i in range(1, max_attempts + 1):
        ...
        if guess == target:
            ...
            break
        elif guess < target and i < max_attempts:     
            ...
            print(f'Sorry, you failed to guess the number in {max_attempts} attempts.')
